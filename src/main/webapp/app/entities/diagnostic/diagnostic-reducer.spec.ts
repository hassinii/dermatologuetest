...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIAGNOSTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIAGNOSTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIAGNOSTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIAGNOSTIC actions', async () => {
      const expectedActions = [
        {
