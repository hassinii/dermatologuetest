...
interface DermatologueModalProps {
  isOpen: boolean;
  toggle: () => void;
  isNew?: boolean;
}
const DermatologueModal: React.FC<DermatologueModalProps> = ({ isOpen, toggle, isNew }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} centered className="p-4" style={{ minWidth: '750px' }}>
      <ModalHeader toggle={toggle}>New Dermatologue</ModalHeader>
      <ModalBody>
...
export default DermatologueModal;
