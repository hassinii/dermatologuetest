...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DERMATOLOGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DERMATOLOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DERMATOLOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DERMATOLOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DERMATOLOGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DERMATOLOGUE actions', async () => {
      const expectedActions = [
        {
