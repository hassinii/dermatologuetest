...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGESTADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGESTADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGESTADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGESTADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGESTADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGESTADE actions', async () => {
      const expectedActions = [
        {
