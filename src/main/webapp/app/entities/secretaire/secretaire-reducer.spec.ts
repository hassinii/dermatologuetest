...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECRETAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SECRETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECRETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECRETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECRETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECRETAIRE actions', async () => {
      const expectedActions = [
        {
