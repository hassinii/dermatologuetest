...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './symptoms.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYMPTOMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SYMPTOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYMPTOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYMPTOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYMPTOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYMPTOMS actions', async () => {
      const expectedActions = [
        {
