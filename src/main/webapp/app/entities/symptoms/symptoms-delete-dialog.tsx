...
export const SymptomsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="assistanteDermatologueApp.symptoms.delete.question">
        <Translate contentKey="assistanteDermatologueApp.symptoms.delete.question" interpolate={{ id: symptomsEntity.id }}>
