...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STADE actions', async () => {
      const expectedActions = [
        {
