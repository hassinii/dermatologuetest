...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './maladie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MALADIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MALADIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MALADIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MALADIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MALADIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MALADIE actions', async () => {
      const expectedActions = [
        {
