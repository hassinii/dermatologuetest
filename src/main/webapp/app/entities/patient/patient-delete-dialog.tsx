...
export const PatientDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="assistanteDermatologueApp.patient.delete.question">
        <Translate contentKey="assistanteDermatologueApp.patient.delete.question" interpolate={{ id: patientEntity.id }}>
