...
export default function BasicFilterDemo() {
  ...
  useEffect(() => {
    ProductService.getProducts().then((data: Customer[]) => {
  ...
  const verifiedBodyTemplate = (rowData: Customer) => {
    return (
      <i
        className={classNames('pi', { 'true-icon pi-check-circle': rowData.verified, 'false-icon pi-times-circle': !rowData.verified })}
      ></i>
    );
  };
